<div class="max-w-2xl mx-auto flex flex-col items-center">
	<div class="w-full p-3 bg-gradient-to-r from-indigo-800 to-blue-500 text-center">
		<div class="animate-ping h-10 w-10 bg-white rounded-full my-28" wire:loading></div>
	...
	<div class="w-full text-center">
		<div class="animate-ping h-10 w-10 bg-blue-700 rounded-full mt-16" wire:loading></div>
